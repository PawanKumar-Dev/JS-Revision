External APIs
What They Are: In a browser (or even Node.js) environment, JavaScript isn’t the only player. The host environment provides various APIs that run outside the JavaScript engine. These are what we call external APIs.
